package com.lyt.AtianSpring.Aop.MapperProxy;
...
public class MapperProxy  implements InvocationHandler {
    ...
    public static  <T> T getMapper(Class classz) {
        return (T) Proxy.newProxyInstance(classz.getClassLoader(), new Class[]{classz},
                new MapperProxy(classz));
    }
//
//    @Test
//    public void TestProxy(){
//        try {
//            ProductMapper productMapper= new MapperProxy( ProductMapper.class).getMapper();
//            Product2 product  =productMapper.getProductById("2021");
...
//    }
    ...
    public <T> T getMapper(){
        T mapper= (T)Proxy.newProxyInstance( (target.getClass()).getClassLoader(),
...
//        System.out.println(" method.invoke(args) 的执行结果 ："+ method.invoke(object.getClass().getDeclaredConstructor().newInstance(),args));
    ...
    public Object callSelect(Annotation annotation, Method method, Object[] args)throws Exception{
        ...
        if(((Select) annotation).type().equals("selectOne")){
            ...
            return  sqlSession.selectCount(statementId,param(method,args));
        }
        return null;
    }
